...
class MainTabBarController: UITabBarController {
    ...
    override func viewDidLoad() {
        ...
        homeNC.navigationBar.barTintColor = UIColor.themeMediumBlue.withAlphaComponent(0.4)
        homeNC.navigationBar.alpha = 0.0
        ...
        feedNC.navigationBar.isTranslucent = true
        feedNC.navigationBar.barTintColor = UIColor.themeMediumBlue.withAlphaComponent(0.4)
        feedNC.navigationBar.alpha = 0.0
